$f = 'C:\xampp4\htdocs\dashboard\Revival_Technologies\resources\views\employees\index.blade.php'
                ...
                <tr>
                    ...
                    <td>
                        <div class="flex items-center gap-1">
                            <button onclick="location.href='{{ route('employees.show', $employee) }}'" class="btn-secondary btn-sm" title="View">👁️</button>
                            <button onclick="location.href='{{ route('employees.edit', $employee) }}'" class="btn-secondary btn-sm" title="Edit">✏️</button>
...
Write-Host "Written. Lines: $($newContent.Split("`n").Length)"
