...
class AssetController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $assets = $q->latest('id')->get()->map(function ($a) {
            ...
            return [
                ...
                'specifications' => !empty($a->specifications) ? $a->specifications : null,
                'notes' => $a->notes,
    ...
    public function show(Asset $asset)
    {
        ...
        $data = [
            ...
            'specifications' => !empty($asset->specifications) ? $asset->specifications : null,
            'notes' => $asset->notes,
    ...
    public function requestAsset(Request $request, Asset $asset)
    {
        $v = Validator::make($request->all(), [
            ...
            'needed_by_date' => 'sometimes|date|after_or_equal:today',
