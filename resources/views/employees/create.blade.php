        ...
        <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 30px;">
            ...
            <div>
                ...
                <div class="content-card" style="margin-bottom: 20px;">
                    <h4 style="margin-bottom: 20px; color: #333;">👤 Personal Information</h4>
                ...
                <div class="content-card" style="margin-bottom: 20px;">
                    <h4 style="margin-bottom: 20px; color: #333;">🏢 Employment Information</h4>
                    
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
                        <div>
                            <label style="display: block; margin-bottom: 5px; font-weight: 500;">Department *</label>
                            <select name="department_id" required style="width: 100%; padding: 10px; border: 2px solid #ddd; border-radius: 4px;">
                        ...
                        <div>
                            ...
                            <select name="role_id" required style="width: 100%; padding: 10px; border: 2px solid #ddd; border-radius: 4px;" onchange="showRolePermissions(this.value)">
                        ...
                        <div>
                            <label style="display: block; margin-bottom: 5px; font-weight: 500;">Manager</label>
                            <select name="manager_id" style="width: 100%; padding: 10px; border: 2px solid #ddd; border-radius: 4px;">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                        <div>
                            <label style="display: block; margin-bottom: 5px; font-weight: 500;">Time Zone</label>
                            <select name="time_zone" style="width: 100%; padding: 10px; border: 2px solid #ddd; border-radius: 4px;">
                        ...
                        <div>
                            ...
                            <select name="language" style="width: 100%; padding: 10px; border: 2px solid #ddd; border-radius: 4px;">
                ...
                <div class="content-card">
                    ...
                    <div style="margin-bottom: 20px;">
                        <label style="display: block; margin-bottom: 5px; font-weight: 500;">Annual Salary</label>
                    ...
                    <div style="margin-bottom: 20px;">
                        ...
                        <textarea name="address" rows="2" placeholder="123 Main Street, Apt 4B"
                                  style="width: 100%; padding: 10px; border: 2px solid #ddd; border-radius: 4px;">{{ old('address') }}</textarea>
                    </div>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
                        <div>
                            <label style="display: block; margin-bottom: 5px; font-weight: 500;">Emergency Contact Name</label>
                        ...
                        <div>
                            <label style="display: block; margin-bottom: 5px; font-weight: 500;">Emergency Contact Phone</label>
            ...
            <div>
                <!-- Employee Status -->
                <div class="content-card" style="margin-bottom: 20px;">
                    <h4 style="margin-bottom: 15px; color: #333;">⚙️ Employee Status</h4>
                    
                    <div style="margin-bottom: 15px;">
                        <label style="display: block; margin-bottom: 5px; font-weight: 500;">Status *</label>
                        <select name="status" required style="width: 100%; padding: 10px; border: 2px solid #ddd; border-radius: 4px;">
                            <option value="active" {{ old('status', 'active') == 'active' ? 'selected' : '' }}>Active</option>
                            <option value="pending" {{ old('status') == 'pending' ? 'selected' : '' }}>Pending Onboarding</option>
                            <option value="inactive" {{ old('status') == 'inactive' ? 'selected' : '' }}>Inactive</option>
                        </select>
                        <div style="font-size: 12px; color: #666; margin-top: 5px;">Employee's current status</div>
                    </div>
                    ...
                    <div style="margin-bottom: 15px;">
                        ...
                        <div style="font-size: 12px; color: #666; margin-top: 5px;">Require 2FA for login</div>
                    </div>
                </div>

                <!-- Role Permissions Preview -->
                <div class="content-card" style="margin-bottom: 20px;">
                    <h4 style="margin-bottom: 15px; color: #333;">🔑 Role Permissions</h4>
                ...
                <div class="content-card" style="margin-bottom: 20px;">
                    <h4 style="margin-bottom: 15px; color: #333;">🔖 Employee Number</h4>
                    <div style="background: #f8f9fa; padding: 15px; border-radius: 6px; text-align: center;">
                        <div style="font-size: 12px; color: #666; margin-bottom: 5px;">Will be auto-generated</div>
                        <div id="employee-number-preview" style="font-weight: bold; color: #2196f3;">Select department first</div>
                        <div style="font-size: 12px; color: #666; margin-top: 5px;">Based on department + year</div>
                    </div>
                </div>
                ...
                <div class="content-card">
                    <div style="display: flex; flex-direction: column; gap: 10px;">
                        ...
                        <a href="{{ route('employees.index') }}" class="btn" style="width: 100%; text-align: center;">
                            Cancel
                        </a>
                    </div>
                </div>
