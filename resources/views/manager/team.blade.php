...
<div>
    ...
    <div class="content-card">
        <h4 style="margin-bottom: 20px; color: #333;">👥 My Team Members</h4>
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px; margin-top: 30px;">
        <div class="content-card">
            <h5 style="margin-bottom: 15px; color: #333;">🚀 Quick Actions</h5>
        ...
        <div class="content-card">
            <h5 style="margin-bottom: 15px; color: #333;">📈 Team Performance</h5>
            <div style="color: #666;">
        ...
        <div class="content-card">
            <h5 style="margin-bottom: 15px; color: #333;">📋 Recent Activity</h5>
