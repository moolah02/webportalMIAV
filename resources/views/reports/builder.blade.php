  ...
  Alpine.data('reportBuilder', () => ({
    ...
    presets: [
      ...
      },
      {
        ...
        baseTable: 'clients',
        dateColumn: 'clients.contract_end_date',
        fields: [
          { label: 'Company Name',        expression: 'clients.company_name',         category: 'dimensions' },
          { label: 'Phone',               expression: 'clients.phone',                category: 'dimensions' },
          { label: 'Region',              expression: 'clients.region',               category: 'dimensions' },
          { label: 'Status',              expression: 'clients.status',               category: 'dimensions' },
          { label: 'Priority',            expression: 'clients.priority',             category: 'dimensions' },
          { label: 'Contract Start',      expression: 'clients.contract_start_date',  category: 'dimensions' },
          { label: 'Contract End',        expression: 'clients.contract_end_date',    category: 'dimensions' },
        ],
      },
      {
        id: 'project-pipeline',
        ...
        fields: [
          { label: 'Project Code',   expression: 'projects.project_code',  category: 'dimensions' },
          { label: 'Project Name',   expression: 'projects.project_name',  category: 'dimensions' },
          { label: 'Type',           expression: 'projects.project_type',  category: 'dimensions' },
          { label: 'Status',         expression: 'projects.status',        category: 'dimensions' },
          { label: 'Priority',       expression: 'projects.priority',      category: 'dimensions' },
          { label: 'Start Date',     expression: 'projects.start_date',    category: 'dimensions' },
          { label: 'End Date',       expression: 'projects.end_date',      category: 'dimensions' },
        ],
      },
      {
        ...
        dateColumn: 'visit_terminals.created_at',
        fields: [
          { label: 'Serial Number',  expression: 'visit_terminals.serial_number',    category: 'dimensions' },
          { label: 'Terminal Model', expression: 'visit_terminals.terminal_model',   category: 'dimensions' },
          { label: 'Device Type',    expression: 'visit_terminals.device_type',      category: 'dimensions' },
          { label: 'Condition',      expression: 'visit_terminals.condition',        category: 'dimensions' },
          { label: 'Status',         expression: 'visit_terminals.status',           category: 'dimensions' },
          { label: 'Comments',       expression: 'visit_terminals.comments',         category: 'dimensions' },
          { label: 'Visit Date',     expression: 'visit_terminals.created_at',       category: 'dimensions' },
        ],
      },
    ],
