...
<div>
    ...
    <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 30px;">
        ...
        <div class="content-card">
            <h4 style="margin-bottom: 20px; color: #333;">Cart Items</h4>
        ...
        <div class="content-card" style="height: fit-content;">
            ...
            <a href="{{ route('asset-requests.checkout') }}" class="btn btn-primary" 
               style="width: 100%; text-align: center; padding: 15px; font-size: 16px; margin-bottom: 10px;">
                Proceed to Checkout
            </a>
    ...
    <div class="content-card" style="text-align: center; padding: 60px;">
        ...
        <p style="color: #666; margin-bottom: 30px;">Browse our asset catalog and add items to your cart.</p>
